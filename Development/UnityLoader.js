...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'sampleapp2.data';
    var REMOTE_PACKAGE_BASE = 'sampleapp2.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3477380;
      var PACKAGE_UUID = 'f3f72e8e-d4c0-4846-93e4-296abe235b2b';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 449579, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(449579, 449600, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(449600, 452986, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(452986, 1953062, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(1953062, 3449754, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3449754, 3477380, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_sampleapp2.data');

    };
    Module['addRunDependency']('datafile_sampleapp2.data');
